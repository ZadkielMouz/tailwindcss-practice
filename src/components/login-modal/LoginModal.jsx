...
export const LoginModal = () => {
    return (
        <ItemLayout>
            ...
            <div className="flex items-center justify-center min-h-screen bg-rose-50 rounded-xl shadow-xl">
                {/* Card Container */}
                ...
                <div className="relative flex flex-col m-6 bg-white shadow-2xl rounded-2xl md:flex-row md:space-y-0 md:m-0">
                    ...
                    <div className="p-6 md:p-20">
                        ...
                        <div className="flex flex-col items-center justify-between mt-6 space-y-6 md:flex-row md:space-y-0">
                            ...
                            <button className="w-full md:w-auto flex justify-center items-center p-6 space-x-4 font-Mulish font-bold text-white rounded-md shadow-lg px-9 bg-cyan-700 shadow-cyan-100 hover:bg-opacity-90 hover:shadow-lg border transition hover:-translate-y-0.5 duration-150">
                                <span>Next</span>
                                <svg
                    ...
                    {/* Right Side */}
                    <img src={image} alt="image" className="w-[430px] hidden md:block" />

                    {/* Close Button */}
                    <div className="group absolute top-4 right-4 flex items-center justify-center w-10 h-10 bg-gray-200 rounded-full md:bg-white hover:cursor-pointer hover:-translate-y-0.5 transition duration-150">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
