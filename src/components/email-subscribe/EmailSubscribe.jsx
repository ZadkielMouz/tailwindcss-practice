...
export const EmailSubscribe = () => {
    return (
        <ItemLayout>
            ...
            <div
                className="flex items-center justify-center h-screen bg-zinc-700 rounded-t-xl"
            >
                {/* Card */}
                <div
                    className="bg-zinc-800 p-2 mx-6 rounded-2xl"
                >
                    {/* flex container */}
                    <div
                    ...
                    >
                        ...
                        <img src={image} alt="image"
                            className="object-fit rounded-xl h-80 md:rounded-l-xl md:rounded-r-none transform hover:scale-105 duration-200"
                        />
                        ...
                        <div className="p-6 md:p-12">
                            ...
                            <p className="max-w-xs my-4 text-xs leading-5 tracking-wide text-center text-white md:text-left">
                                Eat better and excercise better. Sign up for the Diet&Fitness newsletter.
                            </p>
