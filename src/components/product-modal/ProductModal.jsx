...
export const ProductModal = () => {
    return (
        <ItemLayout>
            {/* Global Container */}
            <div className="flex items-center justify-center min-h-screen rounded-xl bg-slate-100">
                {/* Card Container */}
                <div className="flex flex-col p-6 m-3 space-y-10 bg-white rounded-2xl shadow-2xl md:flex-row md:space-y-0 md:space-x-10 md:m-0 md:mx-5 md:p-16">
                    {/* Image Div */}
                    <div>
                        <img src={headset} alt="headset" className='mx-auto duration-200 w-60 hover:scale-105' />
                    </div>
                    {/* Content */}
                    <div className="flex flex-col space-y-6">
                        {/* Label & Title Container */}
                        <div className="flex flex-col mb-4 space-y-3 text-center md:text-left"> 
                            <div>{/* Wrapper Div for the Free Shipping Div */}
                            ...
                            <div className="flex flex-col mb-4 space-y-3 text-center md:text-left">
                                ...
                                <p className='text-sm font-light text-gray-400'>This offer is valid until April 3rd or as longas sotck lasts!</p>
                            </div>
                            ...
                            <div className="flex flex-col space-y-4 md:space-y-0 md:space-x-4 md:flex-row">
                                ...
                                <button className='flex md:flex-col md:space-x-0 items-center justify-center py-3 px-5 space-x-3 border-2 border-gray-300 rounded-lg shadow-sm hover:bg-opacity-30 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-150'>
